                      ...
                      <div className="page-header">
                        <div className="row align-items-center">
                          ...
                          <div className="col-auto text-end float-end ms-auto download-grp">
                            <a href="teachers.html" className="btn btn-outline-gray me-2 active"><i className="feather-list" /></a>
                            <a href="teachers-grid.html" className="btn btn-outline-gray me-2"><i className="feather-grid" /></a>
                            <a href="#" className="btn btn-outline-primary me-2"><i className="fas fa-download" /> Download</a>
                            <a href="add-teacher.html" className="btn btn-primary"><i className="fas fa-plus" /></a>
                          </div>
                        </div>
                      </div>
