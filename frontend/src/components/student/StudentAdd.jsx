                      ...
                      <form>
                        <div className="row">
                          <div className="col-12">
                            <h5 className="form-title student-info">Student Information <span><a href="javascript:;"><i className="feather-more-vertical" /></a></span></h5>
                          </div>
                          ...
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              ...
                              <input className="form-control" type="text" placeholder="Enter Admission ID" />
                            </div>
                          </div>
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
