                ...
                <div className="row align-items-center">
                  <div className="col">
                    ...
                    <ul className="breadcrumb">
                      <li className="breadcrumb-item"><a href="hostel.html">Hostel</a></li>
                        ...
                        <div className="row">
                          ...
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>Block <span className="login-danger">*</span></label>
                              <input type="text" className="form-control" />
                            </div>
                          </div>
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>Room No <span className="login-danger">*</span></label>
                              <input type="text" className="form-control" />
                            </div>
                          </div>
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>Room Type <span className="login-danger">*</span></label>
                          ...
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>No of Beds <span className="login-danger">*</span></label>
                              <input type="text" className="form-control" />
                            </div>
                          </div>
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>Cose per Bed <span className="login-danger">*</span></label>
                              <input type="text" className="form-control" />
                            </div>
                          </div>
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>Availability <span className="login-danger">*</span></label>
                              <select className="form-control select">
