                ...
                <div className="row align-items-center">
                  <div className="col">
                    ...
                    <ul className="breadcrumb">
                      <li className="breadcrumb-item"><a href="library.html">Library</a></li>
                        ...
                        <div className="row">
                          ...
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>Book ID <span className="login-danger">*</span></label>
                              <input type="text" className="form-control" />
                            </div>
                          </div>
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>Book Name <span className="login-danger">*</span></label>
                              <input type="text" className="form-control" />
                            </div>
                          </div>
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>Language <span className="login-danger">*</span></label>
                          ...
                          <div className="col-12 col-sm-4">
                            <div className="form-group local-forms">
                              <label>Class</label>
                              <select className="form-control select">
                                <option>Select Class <span className="login-danger">*</span></option>
                                <option>LKG</option>
                                <option>UKG</option>
                                <option>1</option>
                                <option>2</option>
